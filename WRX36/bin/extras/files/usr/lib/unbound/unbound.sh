...
unbound_mkdir() {
  ...
  cp -pr $UB_ETCDIR/root-anchors $UB_VARDIR/
  cp -p $UB_ETCDIR/icannbundle.pem $UB_VARDIR/
  [ -f $UB_VARDIR/root.key ] || { unbound-anchor; cp $UB_VARDIR/root.key $UB_ETCDIR/root.key; }
