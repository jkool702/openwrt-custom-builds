...
# These more-or-less outline the steps I went through to build the image.
# should you want to re-compile this yourself, following these steps will get you 99% of the way there
...
git clone https://github.com/jkool702/openwrt.git --branch=main-cur
